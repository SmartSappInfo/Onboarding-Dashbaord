...
const WEBSITE_URL = 'https://smartsapp.com';
    ...
    <div className="light min-h-screen bg-white font-body text-slate-900 flex flex-col selection:bg-primary/10">
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-16">
        <motion.div
          ...
          className="w-full max-w-xl text-center space-y-6 sm:space-y-8"
        >
          <AnimatedCheck />

          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight leading-tight">
            Your Demo Request is <span className="text-emerald-600">successfully sent.</span>
          </h1>
          ...
          <div className="pt-2 sm:pt-4">
            <Button
              ...
              asChild
            >
              <Link href={WEBSITE_URL} className="flex items-center justify-center gap-2">
                Go to Website
