      ...
      <div className="max-w-7xl mx-auto space-y-8 text-left">
            ...
            <Card className="rounded-2xl border-none ring-1 ring-border shadow-sm bg-background">
                <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Total Registrants</p>
             ...
             <Card className="rounded-2xl border-none ring-1 ring-border shadow-sm bg-background">
                <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Attended</p>
                            <p className="text-3xl font-black text-emerald-600 dark:text-emerald-500">{stats.attended}</p>
                        </div>
             ...
             <Card className="rounded-2xl border-none ring-1 ring-border shadow-sm bg-background">
                <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Pending/No Show</p>
                            <p className="text-3xl font-black text-amber-600 dark:text-amber-500">{stats.pending}</p>
                        </div>
        ...
        <Card className="rounded-2xl border-none overflow-hidden ring-1 ring-border shadow-sm">
            <CardHeader className="bg-muted/30 border-b flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6">
                <div>
                    <CardTitle className="text-lg font-black uppercase tracking-tight">Registration Roster</CardTitle>
            ...
            <CardContent className="p-0 bg-background">
                {!filteredRegistrants || filteredRegistrants.length === 0 ? (
                    <div className="flex flex-col items-center justify-center p-12 text-center">
                        ...
                        <h3 className="text-sm font-black uppercase tracking-widest text-foreground">No Registrants Found</h3>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-muted/10 hover:bg-muted/10">
                                    ...
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest">Registered</TableHead>
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest">Status</TableHead>
                                    <TableHead className="w-[100px] text-right text-[10px] font-black uppercase tracking-widest">Action</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
