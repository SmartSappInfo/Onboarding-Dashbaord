...
export default function MeetingCalendar({ meetings, onMeetingClick }: MeetingCalendarProps) {
 ...
 <span className={cn(
                                    "text-xs font-semibold tabular-nums transition-all",
                                ...
                                {dayMeetings.length > 0 && (
                                    <Badge className="bg-primary/10 text-primary border-none font-semibold tabular-nums h-5 px-1.5 rounded-lg text-[9px]">
                                        {dayMeetings.length}
                                    </Badge>
                                )}
                            </div>
 ...
 <span className="text-[8px] font-semibold tabular-nums">{format(new Date(meeting.meetingTime), 'p')}</span>
                                            </div>
 <p className="text-[10px] font-semibold tracking-tight truncate leading-none mb-0.5">
                                                {meeting.entityName}
                                            </p>
