...
export default function ScheduledMessagesPage() {
 ...
 <TableHeader className="bg-muted/30">
                                <TableRow>
 <TableHead className="text-[10px] font-semibold pl-6">Scheduled For</TableHead>
 <TableHead className="text-[10px] font-semibold ">Medium</TableHead>
 <TableHead className="text-[10px] font-semibold ">From (ID)</TableHead>
 <TableHead className="text-[10px] font-semibold ">Recipient</TableHead>
 <TableHead className="text-[10px] font-semibold ">Preview</TableHead>
 ...
 <TableCell className="font-mono text-[10px] font-semibold">{msg.sender || msg.senderName}</TableCell>
