...
function TemplateCard({ template, cloningId, onPreview, onEdit, onClone, onDelete }: TemplateCardProps) {
 ...
 <span className="text-[7px] font-semibold text-slate-900">Handset Simulator</span>
                        </div>
                    </div>
                )}
...
export function TemplateGallery({
 ...
 <SelectTrigger className="h-12 w-full md:w-[140px] rounded-2xl bg-muted/20 border-none font-semibold text-[10px] ">
 ...
 <SelectTrigger className="h-12 w-full md:w-[140px] rounded-2xl bg-primary/10 border-none font-semibold text-[10px] text-primary">
