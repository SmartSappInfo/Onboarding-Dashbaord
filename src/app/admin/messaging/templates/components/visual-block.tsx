...
export function VisualBlock({ 
 ...
 className={cn("font-semibold tracking-tight leading-tight m-0", sizeClass)}
                        />
                    ) : (
                        <Tag 
 className={cn("font-semibold tracking-tight leading-tight m-0", sizeClass)} 
 ...
 <Button variant={block.style?.variant as any || 'default'} className="rounded-xl font-bold h-12 px-8 shadow-md">
