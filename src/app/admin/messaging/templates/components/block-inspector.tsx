...
export function BlockInspector({ block, onUpdate, templateCategory }: BlockInspectorProps) {
 ...
 <Label className="text-[10px] font-semibold text-muted-foreground ml-1">Content</Label>
                            <Input 
                                value={block.title || ''} 
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-semibold text-muted-foreground ml-1">Importance Level</Label>
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-semibold text-muted-foreground ml-1">Body Text</Label>
                        <Textarea 
                            value={block.content || ''} 
 ...
 <div className="space-y-6">
 <div className="space-y-2">
 <Label className="text-[10px] font-semibold text-muted-foreground ml-1">Button Label</Label>
 <Input value={block.title || ''} onChange={e => onUpdate({ title: e.target.value })} className="font-bold rounded-xl h-11" />
                        </div>
 <div className="space-y-2">
 <div className="flex justify-between items-center px-1">
 <Label className="text-[10px] font-semibold text-muted-foreground">Target Link</Label>
                                {isFinanceContext && (
                                    <TooltipProvider>
                                        <Tooltip>
 ...
 <span className="text-[10px] font-mono font-semibold tabular-nums">{block.style?.width ? parseInt(block.style.width) : (block.type === 'heading' ? 22 : 16)}pt</span>
                            </div>
                            <Slider 
 ...
 <div className="space-y-3">
 <Label className="text-[10px] font-semibold text-muted-foreground block ml-1">Alignment</Label>
