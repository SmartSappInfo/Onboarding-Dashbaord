        ...
        <Card className="bg-card/40 backdrop-blur-md border-border/50 shadow-md">
          <CardHeader className="p-4 flex flex-row items-center justify-between space-y-0">
            <div>
              ...
              <div className="text-3xl font-extrabold mt-1 text-blue-400">1,248</div>
            </div>
        ...
        <Card className="bg-card/40 backdrop-blur-md border-border/50 shadow-md">
          <CardHeader className="p-4 flex flex-row items-center justify-between space-y-0">
            <div>
              ...
              <div className="text-3xl font-extrabold mt-1 text-sky-400">382</div>
            </div>
            <Activity className="h-8 w-8 text-sky-500/50" />
          </CardHeader>
        </Card>
        <Card className="bg-card/40 backdrop-blur-md border-border/50 shadow-md">
          <CardHeader className="p-4 flex flex-row items-center justify-between space-y-0">
            <div>
              ...
              <div className="text-3xl font-extrabold mt-1 text-blue-400">89 Leads</div>
            </div>
              ...
              recentProspects.map((p) => (
                <div key={p.id} className="flex justify-between items-center border-b border-border/30 pb-3 last:border-0 last:pb-0">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge className="bg-blue-500/10 text-blue-400 hover:bg-blue-500/10 text-[9px] font-bold">Score: {p.scoring.overallScore}%</Badge>
                    {p.syncStatus === 'synced' ? (
                      <Badge className="bg-blue-500 text-black hover:bg-blue-500 text-[8px] uppercase font-bold">Synced</Badge>
                    ) : (
