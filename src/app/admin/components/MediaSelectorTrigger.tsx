            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-2">
                    <Button 
                        ...
                        className="rounded-xl font-bold h-10 px-4 gap-2 border-2 hover:bg-primary/5 hover:border-primary/30 transition-all uppercase text-[10px] tracking-widest"
                    >
                    ...
                    <Tabs defaultValue="upload" className="w-full">
                        <DialogHeader className="p-8 border-b bg-muted/30">
                            <div className="flex items-center justify-between gap-4">
                                <div>
                                    <DialogTitle className="text-2xl font-black uppercase tracking-tight">{label}</DialogTitle>
                                ...
                                <TabsList className="bg-background border shadow-sm h-11 p-1 rounded-xl">
                                    <TabsTrigger value="upload" className="rounded-lg font-black uppercase text-[10px] tracking-widest px-4 gap-2">
                                        <Upload className="h-3.5 w-3.5" /> Upload
                                    </TabsTrigger>
                                    <TabsTrigger value="library" className="rounded-lg font-black uppercase text-[10px] tracking-widest px-4 gap-2">
                            ...
                            <TabsContent value="library" className="mt-0">
                                <div className="py-12 text-center flex flex-col items-center gap-4">
                                    ...
                                    <div className="space-y-1">
                                        <h3 className="text-lg font-black uppercase tracking-tight">Institutional Library</h3>
                                    ...
                                    <Button 
                                        ...
                                        className="mt-4 rounded-xl font-black px-8 h-12 gap-2 shadow-xl"
                                    >
                                        Open Full Browser
                                    </Button>
                                </div>
