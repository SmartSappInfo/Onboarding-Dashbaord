...
export default function OrganizationSwitcher() {
 ...
 <span className="text-[9px] font-semibold leading-none mb-0.5 opacity-60">System Context</span>
 ...
 <p className="text-[8px] font-bold text-muted-foreground leading-relaxed tracking-tighter">
