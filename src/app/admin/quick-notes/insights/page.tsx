...
import { ArrowLeft, TrendingUp, Sliders } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { useWorkspace } from '@/context/WorkspaceContext';
import { useUser } from '@/firebase';
import { InsightCenterView } from '../components/insights/InsightCenterView';
  ...
  if (!activeWorkspaceId) {
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center space-y-3">
        ...
        <p className="text-sm font-semibold text-muted-foreground">Select a workspace to open Insight Center...</p>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between gap-4 border-b border-border/40 pb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-muted-foreground">
            Company Brain / Executive Insight Center
          </span>
        </div>
