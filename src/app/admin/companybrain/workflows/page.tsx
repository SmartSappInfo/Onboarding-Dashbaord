...
/**
 * @fileOverview CompanyBrain 2.0 Phase 9: Autonomous Workflows & Event Triggers Hub Page
 * Route: `/admin/companybrain/workflows`
 *
 * ARCHITECTURAL GUIDELINES & CAUTION FOR MAINTAINERS (Rule 10):
 * 1. Single Central Workflows Console:
 *    - Full interactive pipeline builder, execution monitor, and blueprint gallery.
