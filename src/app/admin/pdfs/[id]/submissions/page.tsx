...
export default function SubmissionsPage() {
 ...
 <TabsTrigger value="analytics" className="rounded-xl font-semibold text-[10px] px-8 gap-2">
 ...
 <Button onClick={handleDownloadAll} disabled={isProcessingBatch || !!downloadingId} className="h-10 px-6 font-semibold text-[10px] bg-primary text-primary-foreground hover:bg-primary/90 rounded-l-xl">
                                            {isProcessingBatch ? (
 ...
 <DropdownMenuLabel className="text-[10px] text-muted-foreground p-3">Filename Reference</DropdownMenuLabel>
                                                <DropdownMenuSeparator />
 ...
 <div className="bg-primary/10 p-2.5 rounded-xl"><Users className="h-5 w-5 text-primary" /></div>
                            <div>
 <p className="text-[10px] font-bold text-muted-foreground tracking-wider mb-1 leading-none">Total Signatures</p>
 <p className="text-2xl font-semibold">{isLoading ? '...' : submissions?.length || 0}</p>
                            </div>
                        </CardContent>
                    </Card>
 <Card className="bg-card shadow-sm border-border/50 rounded-xl">
 ...
 <div className="bg-green-500/10 p-2.5 rounded-xl text-green-600"><Clock className="h-5 w-5" /></div>
                            <div>
 <p className="text-[10px] font-bold text-muted-foreground tracking-wider mb-1 leading-none">Last Signature</p>
 ...
 <TableHead key={field.id} className="text-[10px] font-semibold py-4">
 ...
 <TableHead className="text-[10px] font-semibold py-4">Submitted At</TableHead>
 <TableHead className="w-[120px] text-right py-4 pr-6 text-[10px] font-semibold ">Actions</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
 ...
 <DropdownMenuLabel className="text-[10px] font-semibold text-muted-foreground px-3 py-2">Entry Actions</DropdownMenuLabel>
 ...
 <CardDescription className="text-xs font-bold mt-1">Visualizing scroll depth and signing retention.</CardDescription>
                        </CardHeader>
 ...
 return <div className="rounded-xl border bg-background p-3 shadow-2xl text-xs space-y-1"><p className="font-semibold ">{d.label}</p><p className="text-primary font-bold">{d.count} Users Reached</p><p className="text-muted-foreground">{d.percentage.toFixed(1)}% of total traffic</p></div>;
                                            }
                                            return null;
                                        }} />
 ...
 return <text x={x + width + 10} y={y + height / 2 + 4} className="text-[10px] font-semibold tracking-tighter text-muted-foreground opacity-60">{value} ({pct.toFixed(0)}%)</text>;
                                            }} />
                                        </Bar>
                                    </BarChart>
                                </ResponsiveContainer>
                            ) : (
 <div className="h-full flex flex-col items-center justify-center text-center opacity-20 gap-3"><BarChart3 className="h-12 w-12" /><p className="font-semibold text-[10px] ">Collecting Engagement Pulse...</p></div>
                            )}
                        </CardContent>
                    </Card>
 ...
 <div className="py-32 text-center opacity-20 space-y-3"><CheckCircle2 className="h-10 w-10 mx-auto" /><p className="text-[10px] font-semibold ">No Significant Drop-offs</p></div>
                            )}
                        </CardContent>
                    </Card>
                </div>
