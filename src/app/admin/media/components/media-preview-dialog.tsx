...
export default function MediaPreviewDialog({ asset, open, onOpenChange }: MediaPreviewDialogProps) {
 ...
 <DialogDescription className="text-[9px] font-semibold text-muted-foreground/60 mt-1.5 flex items-center gap-2">
 ...
 <p className="text-[10px] font-semibold text-destructive mr-2">Confirm Permanent Deletion?</p>
                        <Button 
                            variant="destructive" 
                            size="sm" 
