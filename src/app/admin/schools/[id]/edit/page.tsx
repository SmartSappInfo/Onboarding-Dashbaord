...
import { Calendar as CalendarIcon, ArrowLeft, Loader2, Building, MapPin, ImageIcon, User, Plus } from 'lucide-react';
  ...
  const onSubmit = (data: FormData) => {
    if (!firestore || !user) {
      toast({
        variant: "destructive",
        title: "Error",
        description: "Firestore connection unavailable.",
      });
      return;
    }
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} className="h-12 rounded-xl bg-muted/20 border-none shadow-none focus:ring-1 focus:ring-primary/20 font-black text-center" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
            ...
            <Card className="border-none shadow-sm ring-1 ring-border rounded-2xl overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-xl border-none bg-primary/5 p-4 transition-all hover:bg-primary/10">
                      <div className="space-y-0.5">
                        <FormLabel className="text-xs font-black uppercase tracking-tight text-primary">Drone Footage</FormLabel>
                      </div>
                      <FormControl>
    ...
    <div className="h-full overflow-y-auto p-4 sm:p-6 md:p-8 bg-muted/5">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col gap-1">
            <h1 className="text-4xl font-black tracking-tight text-foreground">Update Profile</h1>
            <p className="text-muted-foreground font-medium">Modify geographic assignment and staff focal directory.</p>
        </div>
