                                ...
                                <div key={cat.name} className="flex items-center justify-between group">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] font-semibold text-muted-foreground">{cat.count} Tasks Resolved</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-xl font-bold text-primary tabular-nums tracking-tighter">{cat.avgDays}d</p>
                                        <p className="text-[8px] font-semibold text-muted-foreground uppercase opacity-40">Mean Duration</p>
                                    </div>
                                </div>
                            )) : (
