...
export default function TaskCalendar({ tasks, onTaskClick }: TaskCalendarProps) {
 ...
 <p className={cn(
                                                        "text-[9px] font-semibold uppercase tracking-tight truncate leading-none",
                                                        isDone && "line-through"
                                                    )}>
                                                        {task.title}
                                                    </p>
                                                    {task.entityName && (
 <p className="text-[7px] font-bold text-muted-foreground tracking-tighter truncate mt-0.5 opacity-60">
                                                            {task.entityName}
                                                        </p>
                                                    )}
                                                </div>
