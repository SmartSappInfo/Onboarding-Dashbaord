                                ...
                                <CardHeader className="p-6 pb-4">
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <div className="min-w-0 flex flex-col gap-0.5">
                                            ...
                                            <Badge variant={org.status === 'archived' ? 'outline' : 'default'} className="text-[10px] font-bold uppercase tracking-widest px-2 h-5 mt-1 bg-primary/5 text-primary border-primary/20 w-fit">
                                                {org.status || 'Active Registry'}
                                            </Badge>
                                        </div>
                                    </div>
