...
export default function OrganizationsClient() {
    ...
    return (
        <div className="h-full overflow-y-auto p-4 sm:p-6 md:p-8 space-y-8 bg-muted/5 text-left">
            <div className="max-w-7xl mx-auto space-y-8">
                {/* Header */}
                <div className="flex items-center justify-between px-1">
                    <div className="text-left">
                        <h1 className="text-3xl font-black uppercase tracking-tight text-foreground">Organizations</h1>
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div className="flex items-center gap-3 min-w-0 flex-1">
                                        ...
                                        <div className="min-w-0">
                                            <CardTitle className="text-base font-black uppercase tracking-tight truncate">
                                                {org.name}
                                            </CardTitle>
                                            <Badge variant={org.status === 'archived' ? 'outline' : 'default'} className="text-[8px] font-black uppercase px-1.5 h-4 mt-1">
                                                {org.status || 'active'}
                                            </Badge>
                                        </div>
                                    </div>
                ...
                {!isLoading && organizations?.length === 0 && (
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-lg font-black uppercase tracking-tight mb-2">No Organizations</h3>
                        <p className="text-sm text-muted-foreground mb-6">Get started by creating your first organization</p>
                        <Button onClick={() => handleOpenEdit()} className="rounded-xl font-black px-6 shadow-lg gap-2">
