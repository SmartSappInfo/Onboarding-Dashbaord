...
const questionTypes: { type: SurveyElement['type']; label: string; icon: React.ElementType }[] = [
    ...
    { type: 'ces', label: 'CES (1-7)', icon: SmilePlus },
    { type: 'matrix', label: 'Matrix Grid', icon: Grid3X3 },
    { type: 'ranking', label: 'Ranking / Order', icon: ArrowUpDown },
    { type: 'slider', label: 'Continuous Slider', icon: Sliders },
    { type: 'signature', label: 'Digital Signature', icon: PenTool },
    { type: 'consent', label: 'Consent / Terms', icon: CheckSquare },
    { type: 'calculated', label: 'Calculated Field', icon: Calculator },
    { type: 'email', label: 'Email Address', icon: Mail },
    { type: 'phone', label: 'Phone Number', icon: Phone },
    { type: 'number', label: 'Numeric Value', icon: Hash },
    { type: 'link', label: 'Website URL', icon: Link },
