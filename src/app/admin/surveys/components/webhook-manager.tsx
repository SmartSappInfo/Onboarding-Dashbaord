...
export default function WebhookManager() {
 ...
 <Label className="text-[10px] font-semibold text-primary/60 ml-1">Select from Library</Label>
                                        <Controller
                                            name="webhookId"
                                            control={control}
                                            render={({ field }) => (
 ...
 className="h-10 rounded-xl font-bold border-dashed border-2 gap-2 text-[10px] "
                                    >
 ...
 <DialogContent className="sm:max-w-md rounded-2xl overflow-hidden">
                    <DialogHeader>
 <DialogTitle className="text-xl font-semibold tracking-tight">Create Webhook</DialogTitle>
 <DialogDescription className="text-xs font-medium">Save this endpoint to your library for reuse.</DialogDescription>
                    </DialogHeader>
 <div className="space-y-4 py-4">
 <div className="space-y-2">
 <Label className="text-[10px] font-semibold text-muted-foreground ml-1">Endpoint Name</Label>
                            <Input 
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-semibold text-muted-foreground ml-1">Target URL</Label>
                            <Input 
                                type="url" 
 ...
 className="font-semibold rounded-xl px-8 shadow-lg"
                        >
