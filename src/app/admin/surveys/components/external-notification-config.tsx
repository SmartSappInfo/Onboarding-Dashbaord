                ...
                <div className="flex items-center justify-between p-6">
                    <div className="flex items-center gap-4 text-left">
                        ...
                        <div className="space-y-0.5">
                            <Label className="text-base font-black uppercase tracking-tight">External Contact Alerts</Label>
                            <p className="text-[10px] text-muted-foreground font-black uppercase tracking-tighter">Notify stakeholders at the campus level</p>
                        </div>
                    </div>
                    <Controller
                ...
                {!entityId && (
                    <div className="px-6 pb-6">
                        <div className="p-3 rounded-xl bg-orange-50 border border-orange-100 flex items-center gap-3">
                            ...
                            <p className="text-[9px] font-bold text-orange-800 leading-relaxed uppercase tracking-tighter">
                ...
                {enabled && entityId && (
                    <div className="p-6 pt-0 space-y-8 animate-in fade-in slide-in-from-top-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                            <div className="space-y-4">
                                <Label className="text-[10px] font-black uppercase tracking-widest text-primary ml-1">1. Stakeholder Filtering</Label>
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Filter className="h-3 w-3 text-muted-foreground" />
                                            <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Contact Roles to Notify</span>
                                        </div>
                                        <Controller
                                        ...
                                        />
                                        <p className="text-[9px] font-bold text-muted-foreground/60 uppercase tracking-tight leading-relaxed italic">
