...
export default function AutomationsClient() {
                                        ...
                                        >
                                            ...
                                            <CardContent className="p-6 flex-1 flex flex-col justify-between gap-6">
                                                ...
                                                <div className="pt-4 border-t border-border/50 flex items-center justify-between shrink-0" onClick={(e) => e.stopPropagation()}>
                                                    ...
                                                    <div className="flex items-center gap-1.5 opacity-70 md:opacity-0 group-hover:opacity-100 hover:opacity-100 transition-opacity">
                                                ...
                                                filteredAutomations.map((auth) => (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="pr-6 py-6 text-right align-middle" onClick={(e) => e.stopPropagation()}>
                                                            <div className="flex items-center justify-end gap-1.5 opacity-70 md:opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
 ...
 <AlertCircle className="h-2.5 w-2.5" /> Logic Error
                                            ...
                                            <Button 
                                                variant="ghost" 
                                                size="sm" 
                                                className="h-9 rounded-xl opacity-80 md:opacity-0 group-hover:opacity-100 hover:opacity-100 transition-opacity font-semibold text-[9px] gap-2 bg-primary/5 text-primary"
 ...
 <div className="absolute top-4 right-4 z-10">
                                        <Button 
                                            variant="ghost" 
                                            size="icon" 
                                            className="h-8 w-8 bg-slate-900 text-white rounded-lg opacity-80 md:opacity-0 group-hover:opacity-100 transition-all"
                                            onClick={() => {
                                                if (selectedRun) navigator.clipboard.writeText(JSON.stringify(selectedRun.triggerData, null, 2));
                                                toast({ title: 'Payload Copied' });
                                            }}
