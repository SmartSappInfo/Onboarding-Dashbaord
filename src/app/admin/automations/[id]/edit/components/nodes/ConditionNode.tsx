    ...
    return (
        <div className={cn(
            ...
            <Card className={cn(
                ...
                <div className="bg-amber-500 p-3 flex items-center justify-between border-b border-amber-600/20">
                    <div className="flex items-center gap-2 text-white">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">Evaluate Logic</span>
                    </div>
                    <div className="h-1.5 w-1.5 rounded-full bg-white opacity-40" />
                </div>
                <div className="p-4 space-y-2">
                    <p className="text-xs font-black uppercase text-foreground leading-tight">{data.label || 'Decision Branch'}</p>
                    <div className="flex flex-wrap gap-1.5 pt-1">
                        <Badge variant="outline" className="text-[7px] font-black uppercase px-1.5 h-4 border-amber-100 bg-amber-50 text-amber-600">
            ...
            <div className="absolute -bottom-6 left-1/4 flex flex-col items-center">
                <span className="text-[8px] font-black text-emerald-600 uppercase mb-1">True</span>
                <Handle 
                    type="source" 
            ...
            <div className="absolute -bottom-6 right-1/4 flex flex-col items-center">
                <span className="text-[8px] font-black text-rose-600 uppercase mb-1">False</span>
                <Handle 
                    type="source" 
                    position={Position.Bottom} 
                    id="false"
