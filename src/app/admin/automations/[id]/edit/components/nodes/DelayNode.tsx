            ...
            <Card className={cn(
                ...
                <div className="bg-purple-500 p-3 flex items-center justify-between border-b border-purple-600/20">
                    <div className="flex items-center gap-2 text-white">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">Protocol Pause</span>
                    </div>
                    <Hourglass className="h-3.5 w-3.5 text-white/40" />
                </div>
                <div className="p-4 space-y-2">
                    <p className="text-xs font-black uppercase text-foreground leading-tight">{data.label || 'Wait Period'}</p>
                    <div className="flex items-center gap-2 pt-1">
                        <Badge variant="outline" className="text-[8px] font-black uppercase px-2 h-5 bg-purple-50 text-purple-600 border-purple-100">
