...
import { Play, Settings2, ArrowRight } from 'lucide-react';
        ...
        <div className={cn(
            ...
            <Card className={cn(
                ...
                <div className="p-4 space-y-1">
                    <p className="text-xs font-black uppercase text-foreground leading-tight">{data.label || 'Task Step'}</p>
                    <p className="text-[9px] font-bold text-muted-foreground uppercase opacity-60">Module: Operational Hub</p>
                </div>
            </Card>
