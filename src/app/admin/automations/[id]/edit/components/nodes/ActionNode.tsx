...
export function ActionNode({ data, selected }: any) {
 ...
 {selected && <div className="h-1.5 w-1.5 rounded-full bg-card animate-pulse" />}
                </div>
 ...
 <div className="flex flex-wrap gap-1.5">
                                ...
                                {config.priority && (
                                    <Badge variant="outline" className="text-[7px] font-semibold uppercase px-1.5 h-4 bg-background0 border-none">
                                        {config.priority}
                                    </Badge>
                                )}
                            </div>
