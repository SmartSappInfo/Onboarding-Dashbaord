      ...
      >
        <div className="bg-violet-500 p-3 flex items-center justify-between border-b border-violet-600/20">
          <div className="flex items-center gap-2 text-white">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest">Tag Condition</span>
          </div>
        ...
        <div className="p-4 space-y-2">
          ...
          <div className="flex flex-wrap gap-1.5 pt-1">
            {logic ? (
              <Badge
                variant="outline"
                className="text-[7px] font-black uppercase px-1.5 h-4 border-violet-100 bg-violet-50 text-violet-600"
              >
              ...
              <Badge
                variant="outline"
                className="text-[7px] font-black uppercase px-1.5 h-4 bg-muted/50 border-none text-muted-foreground"
              >
                Select Logic
              </Badge>
            )}
