...
const TRIGGER_GROUPS: { label: string; options: { value: AutomationTrigger; label: string; icon: typeof Building; desc: string }[] }[] = [
    ...
    },
    {
        ...
        options: [
            ...
            { value: 'DEAL_STATUS_CHANGED', label: 'Deal Status Changed', icon: Zap, desc: 'Fires when a deal status is changed.' },
            { value: 'DEAL_WON', label: 'Deal Won', icon: Zap, desc: 'Fires when a deal is successfully closed won.' },
            { value: 'DEAL_LOST', label: 'Deal Lost', icon: ShieldAlertIconPlaceholder, desc: 'Fires when a deal is closed lost.' },
            ...
            { value: 'DEAL_SLA_BREACHED', label: 'Deal Stage SLA Breached', icon: ClockIconPlaceholder, desc: 'Fires when time-in-stage exceeds configured SLA limit.' },
            { value: 'DEAL_STALLED', label: 'Deal Stalled', icon: ClockIconPlaceholder, desc: 'Fires when a deal remains inactive/stalled.' },
            { value: 'DEAL_QUOTE_ACCEPTED', label: 'Quote Proposal Accepted', icon: TargetIconPlaceholder, desc: 'Fires when client accepts commercial proposal.' },
            { value: 'DEAL_CONTRACT_SIGNED', label: 'Contract Signed', icon: TargetIconPlaceholder, desc: 'Fires when contract is digitally signed.' },
            { value: 'DEAL_ACTIVITY_LOGGED', label: 'Deal Activity Logged', icon: ActivityIconPlaceholder, desc: 'Fires when a call, meeting, email, or message is logged on a deal.' },
        ],
    },
    {
        label: 'Engagement',
...
const ACTION_TYPES = [
    ...
    { value: 'DIRECT_NOTIFICATION_EMAIL', label: 'Direct Notification (Email)', icon: MailIconPlaceholder, desc: 'Send an un-templated email notification directly to assignees, team members or custom emails.' },
    ...
    { value: 'DIRECT_NOTIFICATION_SMS', label: 'Direct Notification (SMS)', icon: SmartphoneIconPlaceholder, desc: 'Send an un-templated SMS alert directly to assignees, team members or custom numbers.' },
...
const TRIGGER_ICON_MAP_NI: Record<string, React.ElementType> = {
    ...
    DEAL_STATUS_CHANGED: Zap, DEAL_WON: Zap, DEAL_LOST: ShieldAlertIconPlaceholder,
    DEAL_VALUE_CHANGED: DollarSignIconPlaceholder, DEAL_OWNER_CHANGED: TargetIconPlaceholder,
    DEAL_SLA_BREACHED: ClockIconPlaceholder, DEAL_STALLED: ClockIconPlaceholder,
    DEAL_QUOTE_ACCEPTED: TargetIconPlaceholder, DEAL_CONTRACT_SIGNED: TargetIconPlaceholder,
    DEAL_ACTIVITY_LOGGED: ActivityIconPlaceholder,
...
const TRIGGER_LABEL_MAP_NI: Record<string, string> = {
    ...
    DEAL_STATUS_CHANGED: 'Deal Status Changed', DEAL_WON: 'Deal Won', DEAL_LOST: 'Deal Lost',
    DEAL_VALUE_CHANGED: 'Deal Value Changed', DEAL_OWNER_CHANGED: 'Deal Owner Changed',
    DEAL_SLA_BREACHED: 'Deal Stage SLA Breached', DEAL_STALLED: 'Deal Stalled',
    DEAL_QUOTE_ACCEPTED: 'Quote Proposal Accepted', DEAL_CONTRACT_SIGNED: 'Contract Signed',
