...
export default function ConvertLeadModal({ entity, open, onOpenChange }: ConvertLeadModalProps) {
 ...
 <p className="text-[10px] font-semibold text-muted-foreground leading-none mb-1 text-left">Target {singular}</p>
 <p className="text-base font-semibold text-foreground truncate text-left">{entity.displayName}</p>
                        </div>
                    </div>
 ...
 <span className={cn("font-semibold text-xs text-left", targetPipelineId === p.id ? "text-primary text-left" : "text-foreground text-left")}>{p.name}</span>
 ...
 <p className="text-xs font-semibold text-blue-900 text-left">Track Synchronisation</p>
