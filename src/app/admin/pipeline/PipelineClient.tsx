...
export default function PipelineClient() {
 ...
 <SelectTrigger className="h-9 border-none shadow-none focus:ring-0 p-0 text-lg sm:text-xl font-semibold tracking-tighter gap-2 w-auto bg-transparent hover:text-primary transition-colors">
 ...
 <Label className="text-[9px] font-semibold text-muted-foreground ml-1">Zone / Region</Label>
 ...
 <SelectItem value="all" className="text-[10px] font-bold">Global View</SelectItem>
 {zones?.map(z => <SelectItem key={z.id} value={z.id} className="text-[10px] font-bold">{z.name}</SelectItem>)}
                                                </SelectContent>
                                            </Select>
                                        </div>
 <div className="space-y-2 text-left">
 <Label className="text-[9px] font-semibold text-muted-foreground ml-1">Lifecycle State</Label>
 ...
 <SelectItem value="Onboarding" className="text-[10px] font-bold text-blue-600">Onboarding</SelectItem>
 <SelectItem value="Active" className="text-[10px] font-bold text-emerald-600">Active</SelectItem>
 <SelectItem value="Churned" className="text-[10px] font-bold text-rose-600">Churned</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </div>
 {hasActiveFilters && (<div className="pt-4 border-t border-dashed"><Button variant="ghost" onClick={() => { setSearchTerm(''); setZoneFilter('all'); setStatusFilter('all'); }} className="w-full h-8 rounded-lg font-semibold text-[9px] text-rose-600 hover:bg-rose-50 gap-2"><RotateCcw className="h-3 w-3" /> Clear All Filters</Button></div>)}
                                </PopoverContent>
                            </Popover>
                        </motion.div>
                    )}
