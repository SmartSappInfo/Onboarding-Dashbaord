            ...
            <div className="flex flex-col items-end gap-2 shrink-0">
                <DropdownMenu modal={false}>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl opacity-40 group-hover/card:opacity-100 transition-opacity">
                            <MoreVertical className="h-4 w-4" />
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent align="end" className="w-60 rounded-[1.5rem] border-none shadow-2xl p-2 animate-in zoom-in-95 duration-200">
                        ...
                        <DropdownMenuItem asChild className="rounded-xl p-2.5 gap-3">
                            <Link href={`/admin/schools/${school.id}`}>
                                ...
                                <span className="font-black text-xs uppercase tracking-tight">View Full Console</span>
                            </Link>
                        </DropdownMenuItem>
                        ...
                        <DropdownMenuItem className="rounded-xl p-2.5 gap-3" onClick={() => setStatusModalOpen(true)}>
                            ...
                            <span className="font-black text-xs uppercase tracking-tight">Update Lifecycle Status</span>
                        </DropdownMenuItem>
                        ...
                        <DropdownMenuItem className="rounded-xl p-2.5 gap-3" onClick={() => setTransferModalOpen(true)}>
                            ...
                            <span className="font-black text-xs uppercase tracking-tight">Transfer Pipeline</span>
                        </DropdownMenuItem>
                        ...
                        <DropdownMenuItem className="rounded-xl p-2.5 gap-3 text-muted-foreground opacity-60">
                            ...
                            <span className="font-bold text-xs uppercase tracking-tight italic">Archive Record</span>
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
            </div>
            ...
            <div className="flex items-center gap-2 mb-5">
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent className="text-[9px] font-black uppercase tracking-widest">Initialize Task</TooltipContent>
                    </Tooltip>
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent className="text-[9px] font-black uppercase tracking-widest">Send Message</TooltipContent>
                    </Tooltip>
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent className="text-[9px] font-black uppercase tracking-widest">Book Session</TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border/50">
                <div className="flex items-center gap-4">
                    <div className="flex flex-col text-left">
                        ...
                        <span className="text-[8px] font-black uppercase text-muted-foreground tracking-tighter opacity-40 mt-1">Active Roll</span>
                    </div>
                    ...
                    <div className="flex flex-col text-left">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[10px] font-bold text-foreground/80 truncate max-w-[80px] leading-none">{toTitleCase(school.zone?.name || 'Global')}</span>
                        </div>
                        <span className="text-[8px] font-black uppercase text-muted-foreground tracking-tighter opacity-40 mt-1">Region</span>
                    </div>
                </div>
