...
export const CANONICAL_PERMISSIONS_CATALOG: PermissionDefinition[] = [
  ...
  },
  {
    ...
    name: 'View Company Brain',
    section: 'operations',
    feature: 'quickNotes',
    action: 'view',
    description: 'Read shared workspace knowledge, notes, and ideas.',
    riskLevel: 'low',
    dependencies: [],
  ...
  },
  {
    ...
    name: 'Create in Company Brain',
    section: 'operations',
    feature: 'quickNotes',
    action: 'create',
    description: 'Author new knowledge objects, ideas, notes, and decisions.',
    riskLevel: 'low',
  ...
  },
  {
    ...
    name: 'Edit Company Brain',
    section: 'operations',
    feature: 'quickNotes',
    action: 'edit',
    description: 'Edit existing knowledge objects, ideas, and decisions.',
    riskLevel: 'low',
    dependencies: ['operations.quickNotes.view'],
  ...
  },
  {
    ...
    name: 'Delete from Company Brain',
    section: 'operations',
    feature: 'quickNotes',
    action: 'delete',
    description: 'Delete knowledge objects and ideas.',
    riskLevel: 'low',
    dependencies: ['operations.quickNotes.view'],
