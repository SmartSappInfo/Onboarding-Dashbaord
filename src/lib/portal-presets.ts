...
export const DEFAULT_ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    type: 'welcome_video',
    actionLabel: 'Watch Orientation',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    autoVerificationType: 'auto_watch',
    order: 1,
    isRequired: true,
  },
  {
    ...
    autoVerificationType: 'has_profile',
    order: 2,
    isRequired: true,
  },
  {
    ...
    autoVerificationType: 'has_started_lesson',
    order: 3,
    isRequired: true,
  },
  {
    ...
    autoVerificationType: 'has_community_post',
    order: 4,
    isRequired: false,
  },
  {
