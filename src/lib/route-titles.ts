...
export const ADMIN_ROUTE_TITLES: RouteTitleMap = {
  ...
  '/admin/quick-notes': 'Company Brain',
  '/admin/quick-notes/search': 'Global Knowledge Search',
  '/admin/quick-notes/ask': 'Ask Company Brain',
  '/admin/quick-notes/graph': 'Knowledge Graph',
  '/admin/quick-notes/ideas': 'Idea Studio',
  '/admin/quick-notes/campaigns': 'Campaign Intelligence',
  '/admin/quick-notes/federation': 'Knowledge Federation',
  '/admin/quick-notes/inbox': 'Knowledge Inbox',
  ...
  '/admin/quick-notes/agents': 'Domain Specialists & Swarm Collaboration',
  ...
  '/admin/media/ideas': 'Media Idea Canvas',
  '/admin/media/developer': 'Developer & API Keys',
  '/admin/media/governance': 'Media Governance & Audit',
  '/admin/media/experiments': 'Media Experiments & MAB',
  '/admin/media/optimization': 'Media Optimization Radar',
  '/admin/media/copilot': 'Media AI Copilot Studio',
  '/admin/media/analytics': 'Media Command Center',
  '/admin/media/intelligence': 'Content Intelligence',
  '/admin/media/experiences': 'Experience Studio',
  ...
  '/admin/workforce/command-center': 'AI Command Center',
  '/admin/workforce/ai': 'AI Workforce Advisor',
  '/admin/workforce/crm': 'CRM Workload & Transfer',
  '/admin/workforce/enterprise-identity': 'Enterprise SSO & SCIM',
...
export const BACKOFFICE_ROUTE_TITLES: RouteTitleMap = {
  ...
  '/backoffice/media': 'Media Governance',
