...
export const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    ...
    variableContext: 'survey', declaredVariables: ['user_name', 'survey_title', 'respondent_name', 'contact_name', 'contact_email', 'dashboard_link', 'org_name'],
  },
  {
  ...
  },
  {
    ...
    variableContext: 'survey', declaredVariables: ['user_name', 'survey_title', 'respondent_name', 'completion_date', 'score', 'result_message', 'dashboard_link', 'org_name'],
  },
  {
    name: 'Survey Completion Alert (SMS) for Team', category: 'surveys', templateType: 'survey_completion_team', channel: 'sms',
    recipientType: 'internal_alert',
  ...
  // ── Meeting Reschedule & Cancellation Templates ──
  {
    ...
    body: `Dear {{contact_name}},\n\nPlease note that the upcoming session "{{meeting_title}}" has been rescheduled.\n\nNew Details:\n📅 Date: {{meeting_date}}\n⏰ Time: {{meeting_time}} ({{meeting_timezone}})\n📍 Platform: {{meeting_type}}\n🔗 Join Link: [Click Here to Join]({{registrant_join_link}})\n\nBest regards,\n{{org_name}}`,
    variableContext: 'meeting', declaredVariables: ['contact_name', 'meeting_title', 'meeting_date', 'meeting_time', 'meeting_timezone', 'meeting_type', 'registrant_join_link', 'org_name'],
  },
  {
  ...
  {
    name: 'Meeting Rescheduled (Email) for Registrants', category: 'meetings', templateType: 'meeting_rescheduled_registrant', channel: 'email',
    recipientType: 'external_alert',
    subject: 'Rescheduled: {{meeting_title}}',
    body: `Dear {{contact_name}},\n\nPlease note that the upcoming session "{{meeting_title}}" has been rescheduled.\n\nNew Details:\n📅 Date: {{meeting_date}}\n⏰ Time: {{meeting_time}} ({{meeting_timezone}})\n📍 Platform: {{meeting_type}}\n🔗 Join Link: [Click Here to Join]({{registrant_join_link}})\n\nBest regards,\n{{org_name}}`,
    variableContext: 'meeting', declaredVariables: ['contact_name', 'meeting_title', 'meeting_date', 'meeting_time', 'meeting_timezone', 'meeting_type', 'registrant_join_link', 'org_name'],
  ...
  {
    name: 'Meeting Rescheduled (SMS) for Registrants', category: 'meetings', templateType: 'meeting_rescheduled_registrant', channel: 'sms',
    recipientType: 'external_alert',
    body: `Hi {{contact_name}}, {{meeting_title}} has been rescheduled to {{meeting_date}} at {{meeting_time}} ({{meeting_timezone}}). Join: {{registrant_join_link}}`,
    variableContext: 'meeting', declaredVariables: ['contact_name', 'meeting_title', 'meeting_date', 'meeting_time', 'meeting_timezone', 'registrant_join_link'],
  },
  ...
  },
  {
    ...
    recipientType: 'internal_alert',
    subject: 'Rescheduled: {{meeting_title}}',
    body: `Dear {{user_name}},\n\nPlease note that the upcoming session "{{meeting_title}}" has been rescheduled.\n\nNew Details:\n📅 Date: {{meeting_date}}\n⏰ Time: {{meeting_time}} ({{meeting_timezone}})\n📍 Platform: {{meeting_type}}\n🔗 Join Link: [Click Here to Join]({{facilitator_join_link}})\n\nBest regards,\n{{org_name}}`,
    variableContext: 'meeting', declaredVariables: ['user_name', 'meeting_title', 'meeting_date', 'meeting_time', 'meeting_timezone', 'meeting_type', 'facilitator_join_link', 'org_name'],
  },
  {
  ...
  {
    name: 'Meeting Cancelled (Email) for Guests', category: 'meetings', templateType: 'meeting_cancelled_guest', channel: 'email',
    recipientType: 'external_alert',
    subject: 'Cancelled: {{meeting_title}}',
    body: `Dear {{contact_name}},\n\nPlease note that the upcoming session "{{meeting_title}}" scheduled for {{meeting_date}} at {{meeting_time}} has been cancelled.\n\nWe apologize for any inconvenience caused.\n\nBest regards,\n{{org_name}}`,
    variableContext: 'meeting', declaredVariables: ['contact_name', 'meeting_title', 'meeting_date', 'meeting_time', 'org_name'],
  },
  {
    name: 'Meeting Cancelled (SMS) for Guests', category: 'meetings', templateType: 'meeting_cancelled_guest', channel: 'sms',
    recipientType: 'external_alert',
  ...
  {
    name: 'Meeting Cancelled (SMS) for Registrants', category: 'meetings', templateType: 'meeting_cancelled_registrant', channel: 'sms',
    recipientType: 'external_alert',
    body: `Hi {{contact_name}}, {{meeting_title}} scheduled for {{meeting_date}} at {{meeting_time}} has been cancelled.`,
    variableContext: 'meeting', declaredVariables: ['contact_name', 'meeting_title', 'meeting_date', 'meeting_time'],
  },
  ...
  },
  {
    ...
    recipientType: 'internal_alert',
    subject: 'Cancelled: {{meeting_title}}',
    body: `Dear {{user_name}},\n\nThe session "{{meeting_title}}" scheduled for {{meeting_date}} at {{meeting_time}} has been cancelled.\n\nBest regards,\n{{org_name}}`,
    variableContext: 'meeting', declaredVariables: ['user_name', 'meeting_title', 'meeting_date', 'meeting_time', 'org_name'],
  },
  {
