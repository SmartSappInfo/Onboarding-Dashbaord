...
export async function seedPageTemplates(firestore: Firestore): Promise<number> {
    const list: Partial<import('@/lib/types').PageTemplate>[] = [
        ...
        },
        {
            ...
            description: 'A simple page to collect leads and email signups.',
            goal: 'lead_capture',
            isGlobal: true,
            structureJson: {
                sections: [
                    {
                        id: 'hero-1',
                        type: 'section',
                        props: { padding: 'lg', background: 'default' },
                        blocks: [
                            {
                                id: 'hero-block-1',
                                type: 'hero',
                                props: {
                                    title: 'Download our ultimate guide',
                                    subtitle: 'Get all the insights you need immediately.',
                                    align: 'center'
                                }
                            },
                            {
