    ...
    return (
        <DashboardCard title="Communication Health" description="Real-time delivery status and channel efficiency.">
            <div className="space-y-8">
                ...
                <Button variant="outline" asChild className="w-full rounded-xl font-bold h-10 border-primary/10 hover:bg-primary/5 hover:text-primary transition-all group">
