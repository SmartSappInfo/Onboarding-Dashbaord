 ...
 * Prioritizes urgent and today-due tasks for the logged-in manager.
 */
export function TaskWidget() {
    const firestore = useFirestore();
    const { user } = useUser();

    // Query for personal, unresolved tasks ordered by priority and due date
    ...
    return (
        <DashboardCard 
            ...
            description="Active protocols requiring your immediate intervention."
        >
