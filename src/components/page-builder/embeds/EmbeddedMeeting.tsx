...
export function EmbeddedMeeting({ meetingId, pageId, displayMode = 'inline', isInModal = false, onClose }: EmbeddedMeetingProps) {
  ...
  return (
    <div className="text-center p-12 space-y-6">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50">{meeting?.title || 'Book a Session'}</h2>
        {meeting?.meetingTime && (
      ...
      <Button
        ...
        className="w-full h-14 rounded-2xl font-bold text-lg hover:scale-[1.02] active:scale-[0.97] transition-all duration-200 bg-blue-600 hover:bg-blue-700 text-white"
      >
        Book Session
