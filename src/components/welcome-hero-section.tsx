...
export default function WelcomeHeroSection() {
  return (
    <section className="relative w-full bg-background text-foreground pt-32 pb-20 md:pt-40 md:pb-24 h-screen flex items-center justify-center overflow-hidden">
        <LightRays
        ...
        />
      <div className="container px-6 sm:px-10 relative z-10 text-center">
