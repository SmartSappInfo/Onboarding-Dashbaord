...
import { LayoutDashboard, Building, Settings, Calendar, Flame, Trophy, ShieldCheck, GraduationCap, Compass, TrendingUp, Workflow, Bot, SlidersHorizontal } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/revenue-operating-system', icon: SlidersHorizontal, label: 'Revenue OS & Boardroom' },
