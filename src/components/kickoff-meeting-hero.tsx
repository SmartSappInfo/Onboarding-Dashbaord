...
export default function KickoffMeetingHero({ entity, meeting, tokenResult, nextSectionId }: KickoffMeetingHeroProps) {
        ...
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-20">
          ...
          <div className="flex flex-col justify-center items-center text-center md:items-start md:text-left">
            ...
            <h1 className="font-headline text-3xl font-black tracking-tighter sm:text-5xl md:text-6xl uppercase leading-none">
              {getHeroTitle(meeting.type?.id || 'kickoff', entityName, meeting.heroTitle)}
            </h1>
            <p className="mt-6 text-lg leading-relaxed text-foreground/80 font-medium max-w-xl">
              {getHeroDescription(meeting.type?.id || 'kickoff', entityName, meeting.heroDescription)}
            </p>
