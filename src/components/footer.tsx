...
export default function Footer() {
  return (
    <footer className="bg-[#0A1427] text-white">
      <div className="container px-6 sm:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center lg:text-left">
          {/* Column 1: SmartSapp */}
          <div className="space-y-4">
            <Link href="https://www.smartsapp.com" className="flex items-center justify-center lg:justify-start space-x-2">
          ...
          {/* Column 2: MineX */}
          <div className="space-y-4">
            <MinexLogo className="h-10 mx-auto lg:mx-0" />
