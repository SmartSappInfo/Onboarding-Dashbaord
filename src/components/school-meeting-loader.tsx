        ...
        <>
            ...
            <div className="bg-white text-gray-800">
                <div className="space-y-20 py-20 md:space-y-28 md:py-28">
                    ...
                    {/* Section 1: Download */}
                    <section id="download" className="relative py-20 md:py-28 text-center text-white overflow-hidden">
                      <div
                      ...
                      <div className="container px-6 relative">
                        ...
                        <h2 className="mb-4 font-headline text-3xl font-bold md:text-4xl text-white">
                            Want to get Started?
                        </h2>
