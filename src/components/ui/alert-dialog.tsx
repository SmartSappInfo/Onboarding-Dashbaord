...
const AlertDialog = ({ children, ...props }: React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Root>) => {
  ...
  return (
    <AlertDialogDescriptionContext.Provider value={contextValue}>
...
>(({ className, ...props }, ref) => {
  const context = React.useContext(AlertDialogDescriptionContext)
