...
const Header = () => {
  return (
    <header className="fixed top-0 z-50 w-full py-4">
      <div className="mx-auto w-full px-6 md:w-[70%] md:px-0 flex items-center justify-between rounded-lg bg-black/20 backdrop-blur-sm border border-white/10 py-2">
