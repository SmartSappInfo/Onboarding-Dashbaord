...
- [x] 1. Core type definitions and interfaces
...
- [x] 4. Feature flags for phased industry rollout
...
- [x] 5. Zod validation schemas for all industry data types
...
- [x] 5.1 Write property tests for industry data validation schemas
...
- [x] 6. Workspace industry scoping logic
...
- [x] 6.1 Write property tests for workspace scope lock
...
- [x] 6.2 Write unit tests for workspace scoping
...
- [x] 7. Contact adapter extension for dual-read migration pattern
...
- [x] 7.1 Write property tests for dual-read adapter
...
- [x] 9. SaaS industry — existing field mapping and new collections
  - [x] 9.1 Audit existing `InstitutionData` fields against SaaS requirements
  ...
  - [x] 9.2 Create `src/lib/saas-actions.ts`
  ...
  - [x] 9.3 Write unit tests for `saas-actions.ts`
...
- [x] 10. Marketing industry — data model and server actions
  - [x] 10.1 Create `src/lib/marketing-actions.ts`
    ...
    - _Requirements: 6.8–6.13_
  - [x] 10.2 Write unit tests for `marketing-actions.ts`
    - Test each action rejects non-Marketing workspaces
    - Test `createCampaign` links campaign to entity `campaignIds`
    - _Requirements: 6.8–6.13_

- [x] 11. School Enrollment industry — data model and server actions
  - [x] 11.1 Create `src/lib/school-enrollment-actions.ts`
  ...
  - [x] 11.2 Write unit tests for `school-enrollment-actions.ts`
    - Test each action rejects non-SchoolEnrollment workspaces
    - Test `createApplication` links to entity `applicationIds`
    - _Requirements: 4.7–4.10_

- [x] 12. Consultancy industry — data model and server actions
  - [x] 12.1 Create `src/lib/consultancy-actions.ts`
    ...
    - _Requirements: 9.9–9.15_
  - [x] 12.2 Write unit tests for `consultancy-actions.ts`
    - Test each action rejects non-Consultancy workspaces
    - Test `createEngagement` links to entity `engagementIds`
    - _Requirements: 9.9–9.15_

- [x] 13. Real Estate industry — data model and server actions
  - [x] 13.1 Create `src/lib/real-estate-actions.ts`
    ...
    - _Requirements: 7.7–7.13_
  - [x] 13.2 Write unit tests for `real-estate-actions.ts`
    - Test each action rejects non-RealEstate workspaces
    - Test `createProperty` links to entity `propertyIds`
    - _Requirements: 7.7–7.13_

- [x] 14. Law industry — data model and server actions
  - [x] 14.1 Create `src/lib/law-actions.ts`
    ...
    - _Requirements: 5.8–5.15_
  - [x] 14.2 Write unit tests for `law-actions.ts`
...
- [x] 15. Checkpoint — All industry server actions complete
...
- [x] 16. Industry-specific permissions system
...
- [x] 16.1 Write unit tests for permissions
...
- [x] 17. Industry context provider
...
- [x] 18. Sidebar navigation adaptation
...
- [x] 19. Terminology mapping applied to UI
...
- [x] 21. Industry selection UI for workspace creation
...
- [x] 22. Industry-specific pipeline templates
...
- [x] 23. Firestore security rules for industry collections
...
- [x] 23.1 Write integration tests for Firestore security rules
...
- [x] 24. Composite indexes (firestore.indexes.json)
...
- [x] 25. Migration script — Phase 1 and 2 (audit and schema extension)
...
- [x] 26. Migration script — Phase 3 and 4 (data transformation and validation)
...
- [x] 28. Checkpoint — Infrastructure and migration complete
...
- [x] 29. Integration tests for industry workflows
  - [x] 29.1 Write integration tests using Firebase emulator
  ...
  - [x] 29.2 Write integration tests for migration scripts
...
- [x] 30. E2E tests for workspace creation and industry UI
  - [x] 30.1 Write Playwright E2E tests for workspace creation flow
  ...
  - [x] 30.2 Write Playwright E2E tests for industry feature visibility
